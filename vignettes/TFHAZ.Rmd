...
```{r, echo=FALSE, out.width='200%', fig.cap = "Plot of the TF accumulation vector for the chromosome 21, obtained for w=0."}
...
```{r, echo=FALSE, out.width='75%', fig.cap = "Content of the 'bed' file with the coordinates of the seven dense DNA zones found with transcription factor accumulation threshold value equal to 12."}
...
```{r, fig.cap = "Plot of the number of dense DNA zones found varying the TF accumulation threshold value; the point with maximum slope change is plotted circulated with a red full line."}
...
```{r echo=FALSE, out.width = '100%',fig.cap = "Plot of the variances of the principal components."}
knitr::include_graphics('./PCA_1.png')
``` 

```{r echo=FALSE, out.width='100%', fig.cap = "Plot of the cumulate variances of the principal components."}
knitr::include_graphics('./PCA_2.png')
``` 
```{r echo=FALSE, out.width='100%', fig.cap = "Plot of the loadings of the three principle components."}
...
```{r echo=FALSE, fig.align="center", out.width='200%',fig.cap = "Plot of the TF accumulation vector (for the chromosome 21, obtained for w=0) and of the high accumulation DNA zones (red boxes on the x axis) found; the threshold used to find these zones (7,268413) is shown with a red horizontal line."}
knitr::include_graphics('./high_accumulation_zones_TH_7.3_TF_acc_w_0_chr21.png')
```

```{r echo=FALSE, out.width='80%',fig.cap = "Content of the 'bed' file with the coordinates of 31 out of the 93 high accumulation DNA zones found."}
